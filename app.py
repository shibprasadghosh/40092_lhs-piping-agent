...
user_query = st.text_input("Enter your question here in your preferred language (Leave blank if using filters above):")
    ...
    if not user_name.strip():
        ...
        if active_query:
            if not model_list:
                ...
                log_visitor(user_name.strip(), active_query) # ইউজারের নাম সহ লগ সেভ হচ্ছে
