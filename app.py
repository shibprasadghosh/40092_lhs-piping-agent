                ...
                if success:
                    ...
                    if isinstance(final_res, pd.DataFrame):
                        ...
                        if final_res.empty:
                            ...
                            watermark_row[0] = "© Generated by LHS AI-Powered Dashboard - Created by Shib Prasad Ghosh"
                            ...
                            try:
                                ...
                                with pd.ExcelWriter(excel_buffer, engine='openpyxl') as writer:
                                    dl_df.to_excel(writer, index=False, sheet_name='Search_Result')
                                ...
                                dl_col2.warning("⚠️ Excel download requires 'openpyxl' module in requirements.txt. Please use CSV.")
                            
                    else:
                        st.write(final_res)
                else:
                    st.error("❌ Google API is blocking all models or no result found. Details:")
