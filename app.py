                ...
                for m_name in model_list:
                    try:
                        ...
                        if isinstance(final_res, pd.DataFrame):
                            # --- Toggle for Hiding Empty/None Columns ---
...
# --- Footer: Improved Visibility Watermark ---
st.markdown(
    """
    <br><br>
    <div style='text-align: right; color: #888888; font-size: 15px; font-weight: 500; user-select: none; pointer-events: none;'>
